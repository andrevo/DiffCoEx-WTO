...
const int sampleSize = 50; //Number of data points per gene (normally number of individuals from which data is collected, corresponds to columns in the expression data text file)
...
int main()
{
  ...
  outStream.open("RhoAndVar50.txt");
  for (int i = 0; i < numberOfGenes; i++)
    {
      for (int j = 0; j < numberOfGenes; j++)
	{
